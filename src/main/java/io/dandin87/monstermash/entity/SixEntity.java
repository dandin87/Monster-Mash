...
public class SixEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public SixEntity(EntityType<SixEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<SixEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
