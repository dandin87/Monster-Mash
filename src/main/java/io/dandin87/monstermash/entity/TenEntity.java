...
public class TenEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public TenEntity(EntityType<TenEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<TenEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
