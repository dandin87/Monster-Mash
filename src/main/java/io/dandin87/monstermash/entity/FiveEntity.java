...
public class FiveEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public FiveEntity(EntityType<FiveEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<FiveEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
