...
public class ThreeEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public ThreeEntity(EntityType<ThreeEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<ThreeEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
