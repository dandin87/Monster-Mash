...
public class MiniWardenEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public MiniWardenEntity(EntityType<MiniWardenEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<MiniWardenEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
