...
public class SevenEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public SevenEntity(EntityType<SevenEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<SevenEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
