...
public class TwoEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public TwoEntity(EntityType<TwoEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<TwoEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
