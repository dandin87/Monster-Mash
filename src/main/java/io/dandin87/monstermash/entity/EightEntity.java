...
public class EightEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public EightEntity(EntityType<EightEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<EightEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
