...
public class FourEntity extends PiglinEntity implements IAnimatedEntity {
	...
	public FourEntity(EntityType<FourEntity> entityType, World worldIn) {
	...
	public static boolean spawning(EntityType<FourEntity> p_223337_0_, World p_223337_1_, SpawnReason reason,
